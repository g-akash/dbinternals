...
main()
{
	...
	while(fscanf(fp,"%d %s",&pagefetch,op)!=EOF)
	{
		...
		//Lets first access the first page i.e the root of the b+ tree.
		pagefetch = 1;
		int pageinbuf=0;
		int nextpage=-1;
		for(i=0;i<bufsize;i++)
		...
		{
			//First error place starts here
			printf("first\n");
			nextpa=tv.tv_usec;
			nextpa=nextpa%30;
			nextpage=(nextpa*nextpa+200+nextpage)%bufsize;
			nextpage=nextpage%20;
			nextpa=(nextpa*nextpa+200+nextpage)%bufsize;
			printf("%d\n",nextpage);
			//First error place ends here.
		...
		//Now we access the second level entry
		...
		{
			//second error place starts here
			printf("second\n");
			nextpa=tv.tv_usec;
			nextpa=nextpa%30;
			nextpage=(nextpa*nextpa+200+nextpage)%bufsize;
		...
		//finally we access the actual entry
		...
		{
			//third error place starts here
			printf("thirdiii");
			printf("okay");
			//third error place ends here.
